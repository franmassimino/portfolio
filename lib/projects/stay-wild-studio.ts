...
export const stayWildStudio: ProjectData = {
  ...
  keyFeatures: [
    {
      title: "Custom Dawn Theme Styling",
      titleEs: "Personalización del Tema Dawn",
      description: "Customized Shopify's Dawn theme with brand palette, tone, and visual rhythm for a cohesive identity",
      descriptionEs: "Personalización del tema Dawn de Shopify con la paleta de marca, tono y ritmo visual para una identidad cohesiva",
      icon: "palette"
    },
    {
      title: "Mobile-First Product Discovery",
      titleEs: "Descubrimiento de Producto Mobile-First",
      description: "Designed a mobile-first homepage centered around product discovery and craftsmanship",
      descriptionEs: "Diseño de una página de inicio mobile-first centrada en el descubrimiento de productos y artesanía",
      icon: "smartphone"
    },
    {
      title: "Global Shipping & Payments",
      titleEs: "Envíos y Pagos Globales",
      description: "Integrated Sendcloud for global shipping workflows and Stripe for multi-currency payments",
      descriptionEs: "Integración de Sendcloud para flujos de envío globales y Stripe para pagos multi-moneda",
      icon: "globe"
    },
    {
      title: "Email Marketing Integration",
      titleEs: "Integración de Email Marketing",
      description: "Connected Mailchimp for launch communication and ongoing customer engagement",
      descriptionEs: "Conexión de Mailchimp para comunicación de lanzamiento y engagement continuo con clientes",
      icon: "mail"
    },
  ],
  sections: [
  ...
  impact: {
    title: "Business Impact",
    titleEs: "Impacto en el Negocio",
    content: "The brand now operates with a central, reliable online storefront, a checkout and fulfillment pipeline that can support international orders, and the ability to update products, run discount periods, and launch new drops without developer involvement. This wasn't just a store build — it was the foundation for a brand to scale on its own terms.",
    contentEs: "La marca ahora opera con una tienda online central y confiable, un pipeline de checkout y fulfillment que puede soportar pedidos internacionales, y la capacidad de actualizar productos, ejecutar períodos de descuento y lanzar nuevos drops sin involucramiento de desarrolladores. Esto no fue solo la construcción de una tienda, fue la fundación para que una marca escale en sus propios términos.",
  },
  keyTakeaways: [
